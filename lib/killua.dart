...
class Killua extends StatefulWidget {
  @override
  _Killua createState() => _Killua();
  final String imagePath;
  Killua({required this.imagePath});
}

class _Killua extends State<Killua> {
  String _date = 'October 20, 2022';
